...
```javascript
const arr = [11,12,13];
const itr = arr[Symbol.iterator](https://lite.duckduckgo.com/lite?kd=-1&kp=-1&q=Symbol.iterator);
...
Note that you can write custom iterators by defining `obj[Symbol.iterator](https://lite.duckduckgo.com/lite?kd=-1&kp=-1&q=Symbol.iterator)` with the object definition.
