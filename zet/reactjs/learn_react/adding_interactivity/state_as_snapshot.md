...
What do you expect the `alert` to display? Would it display, "You said Hello to Alive"? Or would it display, "You said Hello to Bob"? Make a guess based on what you know, and they try it:
